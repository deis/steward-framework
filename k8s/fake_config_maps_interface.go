...
// Get is the ConfigMapInterface interface implementation. If name is in f.GetReturns, returns
// f.GetReturns[name], nil. Otherwise returns nil, nil
...
// Create is the ConfigMapInterface interface implementation. It appends cm to f.Created and then
...
// Update is the ConfigMapsInterface interface implementation. It currently is not implemented and
// returns nil, nil.
func (f *FakeConfigMapsInterface) Update(*v1.ConfigMap) (*v1.ConfigMap, error) {
	return nil, nil
}

// Patch is the ConfigMapsInterface interface implementation. It currently is not implemented and
// returns nil, nil.
