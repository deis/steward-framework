...
// FakeSecretsNamespacer is a fake implementation of the
// (k8s.io/kubernetes/pkg/client/unversioned).SecretsNamespacer interface that is suitable for use
// in unit tests
...
// Secrets is the (k8s.io/kubernetes/pkg/client/unversioned).SecretsNamespacer interface
// implementation. It returns an empty kcl.SecretsInterface
